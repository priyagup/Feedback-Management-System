...
class REST
{
    ...
    public function initialize($config)
    {
        ...
        log_message('debug', 'inside function Initialized');
    ...
    {
        log_message('debug', 'Inside Post Function');
    ...
    private function _call($method, $uri, $params = array(), $format = NULL)
    {
        ...
        log_message('debug', 'Inside _call');

        log_message('debug', 'Inside _call uri is '.$uri);

        //log_message('debug', 'Inside _call parama are '.$params);
        ...
        log_message('debug', 'Inside _call afte response:'.$response);
    ...
    public function format($format)
    {
        ...
        {
            log_message('info',"Inside the format:".$format);
            $this->format = $format;
        ...
        {
            log_message('info',"Inside the else format:".$format);
    ...
    {
        log_message('debug', 'Inside _formar_response: '.$response);
        ...
        log_message('info','Inside format response and content_Type is:'.$returned_mime);
