        ...
        <nav class="navbar navbar-inverse navbar-fixed-top" role="navigation">
            ...
            <div class="collapse navbar-collapse navbar-ex1-collapse">
                <ul class="nav navbar-nav side-nav">
                    <li class="active">
                        <a href="index.html"><i class="fa fa-fw fa-dashboard"></i> User Dashboard</a>
                    </li>
                    <li>
                        <a href="<?=base_url()?>/index.php/reports/repController/ovrallRatAnalysis"><i class="fa fa-tasks fa-fw"></i> Reports</a>
                    </li>
                </ul>
            </div>
            <!-- /.navbar-collapse -->
        ...
        <div id="page-wrapper">
            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <div class="jumbotron">
                            <h2>Net Promoter Score <small> for <?php echo strtoupper($this->session->userdata('hotel')[0])?></small></h2>
                ...
                <div class="row">
                    <div class="col-md-6">
                        <div class="panel panel-default">
                            <div class="panel-heading">
                                <h3 class="panel-title"><i class="fa fa-long-arrow-right fa-fw"></i><a href="#" id="high"> Good Performance Category wise for <?php echo strtoupper($this->session->userdata('hotel')[0])?></a> </h3>
                            </div>
                    ...
                    <div class="col-md-6">
                        <div class="panel panel-default">
                            <div class="panel-heading">
                                <h3 class="panel-title"><i class="fa fa-long-arrow-right fa-fw"></i><a href="#" id="low"> Low Performance Category wise for <?php echo strtoupper($this->session->userdata('hotel')[0])?></a> </h3>
                            </div>
                            <div class="panel-body">
